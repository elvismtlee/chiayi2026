...
ISSUE_KEYWORDS = {
    "交通停車": ["交通事故", "違停", "停車難", "停車格", "停車費", "霸佔停車",
                 "車禍", "機車", "闖紅燈", "行人穿越", "交通壅塞", "停車場"],
    "道路路平": ["坑洞", "路面", "柏油", "施工", "道路", "路段",
                 "路平", "路坑", "管線挖掘", "鋪路", "道路損壞"],
    "人行步道": ["人行道", "步道", "騎樓", "無障礙", "行人空間"],
    "環境衛生": ["垃圾", "清潔", "廢棄物", "蚊蟲", "臭味",
                 "噪音", "吵鬧", "擾民", "廢水", "污染", "環保"],
    "排水水利": ["淹水", "水溝", "排水", "溝渠", "積水", "颱風", "暴雨", "下水道"],
    "公共安全": ["路燈", "燈", "照明", "黑暗", "消防", "溺水",
                 "事故", "危險建物", "意外"],
    "市場商圈": ["市場", "夜市", "攤販", "商圈", "小吃"],
    "公園綠地": ["公園", "樹木", "草皮", "綠地", "行道樹", "遊樂"],
    "通學安全": ["通學", "學生", "校園", "學童", "上學", "放學"],
    "社福高齡": ["長照", "老人", "社福", "弱勢", "身障", "高齡", "照護"],
    "文化觀光": ["文化", "觀光", "旅遊", "古蹟", "藝術", "節慶", "活動"],
    "行政服務": ["市政", "陳情", "市民服務", "1999", "申請", "質詢", "議會", "議員"],
}
