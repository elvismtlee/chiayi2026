...
# 13 大市政議題分類（對齊 ChatGPT 參考儀表板）
ISSUE_KEYWORDS = {
    "交通停車": ["停車", "違停", "號誌", "交通", "車流", "壅塞", "機車", "公車",
                 "卸貨", "交通事故", "車禍", "闖紅燈", "逆向"],
    "道路路平": ["坑洞", "路平", "路面", "柏油", "施工", "管線", "挖掘", "道路破損",
                 "路段", "橋梁", "道路", "路面坑", "修路"],
    "人行步道": ["人行道", "行人", "斑馬線", "無障礙", "騎樓", "通學步道",
                 "人行", "步道", "盲道"],
    "環境衛生": ["垃圾", "噪音", "異味", "髒亂", "空污", "回收", "清潔",
                 "廢棄物", "蚊蟲", "臭味", "吵鬧", "擾民", "廢水", "污染"],
    "排水水利": ["淹水", "側溝", "下水道", "雨水", "排水", "水溝", "溝渠",
                 "積水", "颱風", "豪雨", "水患"],
    "公共安全": ["路燈", "照明", "危險路口", "治安", "公共設施", "安全",
                 "路燈故障", "燈", "黑暗", "危險", "溺水", "火災"],
    "市場商圈": ["市場", "商圈", "攤商", "攤販", "人潮", "夜市", "傳統市場",
                 "民雄", "東市", "西市"],
    "公園綠地": ["公園", "綠地", "遊具", "樹木", "草皮", "廣場", "休憩",
                 "植樹", "行道樹"],
    "通學安全": ["通學", "校園", "學校", "接送", "學生", "導護", "上下學",
                 "兒童", "小學", "國中"],
    "社福高齡": ["長照", "高齡", "社福", "弱勢", "老人", "身障", "獨居",
                 "托育", "托嬰", "幼兒"],
    "文化觀光": ["文化", "觀光", "歷史", "藝文", "景點", "廟宇", "古蹟",
                 "嘉義特產", "觀光客", "旅遊"],
    "行政服務": ["陳情", "行政", "資訊公開", "服務", "市政", "公所",
                 "里辦公室", "1999", "投訴", "申請"],
}
